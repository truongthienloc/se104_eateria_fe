...
export const ReservationInfoPage = () => {
	return (
		<div className='w-full h-full pl-10 pt-10'>
			...
			<p className='py-10'>
				* Lưu ý : Bạn đi trễ quá 30 phút, nhà hàng sẽ tự động hủy đơn đặt bàn của
				bạn!
			</p>
			<div
				className='flex justify-center items-center rounded-md ml-40 bg-primary text-third w-[150px] h-[40px] cursor-pointer hover:opacity-80'

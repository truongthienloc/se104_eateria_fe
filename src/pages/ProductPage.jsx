    ...
    <div className='flex-1 flex'>
      <div>
        ...
        <div className='flex items-center justify-center mt-8 mb-6'>
          <input className='w-[360px] h-[80px] bg-third border-4 rounded-2xl border-primary pl-4 pr-8 text-2xl font-normal'
            type="text"
          ...
          <button className='w-[80px] h-[80px] bg-primary border-primary rounded-2xl text-fourth text-2xl pl-4 font-normal' onClick={handleSearch}>Tìm</button>
        </div>

        <div className='flex items-center justify-center text-second mt-10'>
          <select className='w-[230px] h-[50px] bg-third border-2 rounded-xl border-primary pl-3 mr-4'
